        ...
        <div class="container-fluid">          
            ...
            <div class="d-flex justify-content-end">
                @if (Route::has('login'))
                    <div class="ps-4">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Панель</a>
                        @else
                            @if (Route::has('register'))                            
                                <a href="{{ route('login') }}" class="ms-2 fw-lighter" style="color: #374151; font-size: .875rem;"><u>Войти</u></a>
                                <a href="{{ route('register') }}" class="ms-2 fw-lighter" style="color: #374151; font-size: .875rem;">Зарегистрироваться</a>
                            @endif
                        @endauth
                    </div>
                @endif
            ...
            <div class="mx-4 pt-4 position-absolute top-50 start-50 translate-middle">              
                ...
                @foreach ($feedbacks as $feedback)
                    <div class="card text-white bg-secondary mb-3" style="max-width: 70rem;">
                        <div class="card-header">#{{ $feedback->id }} / {{ $feedback->created_at }}</div>
                        <div class="card-body">
